...
public class ArbolGrafico extends JPanel 
{
     ...
     * El constructor permite inicializar los atributos de la clase ArbolGrafico
     * y llama al método repaint(), que es el encargado de pintar el Arbol.
     * @param miArbol: dato de tipo ArbolBB que contiene el Arbol a
     * dibujar.
     */
    public ArbolGrafico(ArbolBB miArbol) 
    {
     ...
     * los rectángulos representativos del árbol.
     */
