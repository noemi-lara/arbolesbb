...
public class AppABB extends javax.swing.JFrame {
    ...
    private void botonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se pudo insertar el dato", 
                    "Intenta de nuevo..." + e.getMessage(), 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppABB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
